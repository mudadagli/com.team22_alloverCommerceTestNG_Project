...
public class TC_007 extends TestBaseReport {
    ...
    //Test Case: Tekrar shopping devam etme butonu olmalı
    @Test
    public void test007() throws InterruptedException {
        ...
        //Continue shopping butonunun görünürlügü test edilir
        jse.executeScript("arguments[0].scrollIntoView(true);",ahmetPage.continueShoppingLink);
        Assert.assertTrue(ahmetPage.continueShoppingLink.isDisplayed());
        extentTest.pass("Continue shopping butonunun ekranda oldugu goruldu");
    }
