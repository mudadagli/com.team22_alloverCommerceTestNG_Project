...
public class TC_005 extends TestBaseReport {
    ...
    //Test Case: Shipping bilgileri sag tarafta görülmelive toplam rakam sagda populate etmeli
    @Test
    public void test005() throws InterruptedException {
        ...
        //Shipping ve total bilgilerinin göründügü test edilir
        Assert.assertTrue(ahmetPage.shippingLabel.isDisplayed());
        Assert.assertTrue(ahmetPage.totalLabel.isDisplayed());
        extentTest.pass("Cart sayfasında Shipping ve total bilgilerinin oldugu goruldu");
    }
