...
public class TC_004 extends TestBaseReport {
    ...
    //Test Case: Coupon secenegi olmali
    @Test
    public void test004() throws InterruptedException {
        ...
        //Cart sayfasinda Coupon seceneginin gorunur oldugu test edilir
        Assert.assertTrue(ahmetPage.applyCouponButton.isDisplayed());
        extentTest.pass("Cart sayfasinda Coupon seceneginin oldugu goruldu");
